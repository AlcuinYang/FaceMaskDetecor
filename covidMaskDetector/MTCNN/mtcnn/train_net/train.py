from covidMaskDetector.MTCNN.mtcnn.core.image_reader import TrainImageReader
import datetime
import os
from covidMaskDetector.MTCNN.mtcnn.core.models import PNet,RNet,ONet,LossFn
import torch
from torch.autograd import Variable
import covidMaskDetector.MTCNN.mtcnn.core.image_tools as image_tools
import numpy as np
    ...
    for cur_epoch in range(1,end_epoch+1):
        ...
        for batch_idx,(image,(gt_label,gt_bbox,gt_landmark))in enumerate(train_data):
            ...
            if batch_idx %frequent==0:
                ...
                writer.add_scalars('train', {'train-loss': show5, 'train-acc': show1}, cur_epoch)
                writer.add_scalar('train', {'train-loss': show5, 'train-acc': show2}, cur_epoch)
                writer.add_scalar('lr', lr_list, cur_epoch)
            optimizer.zero_grad()
            all_loss.backward()
            optimizer.step()


        # writer.add_scalar('val/acc', value[val.acc], epoch)
        # writer.add_scalar('val/loss', value[val.loss], epoch)
